/**
 * PASTE YOUR Icons.tsx CODE HERE
 * 
...
export const UploadIcon: React.FC<{className?: string}> = ({ className = "w-10 h-10 mb-3" }) => (
...
export const XIcon: React.FC<{className?: string}> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
...
export const StarIcon: React.FC<{className?: string, filled?: boolean}> = ({ className = "w-4 h-4", filled = false }) => (
