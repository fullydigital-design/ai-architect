...
interface GoogleTemplateVideoProps {
  onBackToHome: () => void;
  onNavigate: (page: string) => void;
}

export function GoogleTemplateVideo({ onBackToHome, onNavigate }: GoogleTemplateVideoProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const mockVideo = 'https://placehold.co/1920x1080/EA4335/FFFFFF?text=Google+Veo+2.0+Video';
  ...
  const modelOptions = [
    { value: 'veo-2', label: 'Veo 2.0 (Latest)' },
    { value: 'veo-1.5', label: 'Veo 1.5' },
    { value: 'veo-1.0', label: 'Veo 1.0' },
  ];
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-white to-red-50/30 flex flex-col overflow-hidden">
      ...
      <header className="flex-none bg-white/80 backdrop-blur-xl border-b border-gray-200 z-50">
        <div className="px-4 lg:px-6 py-3 grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-center gap-1.5 lg:gap-2">
            <button
              className="px-2.5 lg:px-4 py-1.5 lg:py-2 rounded-full font-medium text-xs lg:text-sm uppercase tracking-wide transition-all bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-lg"
            >
            ...
            <div className="px-6 py-6 space-y-4 max-h-[calc(100vh-180px)] overflow-y-auto">
              ...
              <div className="bg-gray-50/50 rounded-2xl p-4">
                ...
                <textarea
                  ...
                  placeholder="A cinematic tracking shot of a sports car driving through a neon-lit city at night, rain reflecting the lights, photorealistic, 4k quality"
                  rows={4}
                  className="w-full px-4 py-3 bg-white rounded-xl focus:outline-none resize-none font-medium text-sm"
                  style={{ border: 'none', boxShadow: 'none' }}
                />
                <p className="mt-2 text-xs text-red-600 font-medium flex items-start gap-1">
                  <span>💡</span>
                  <span>Veo 2.0 creates cinematic videos with realistic motion and physics</span>
                </p>
              </div>
              ...
              <div className="bg-gray-50/50 rounded-2xl p-4">
                ...
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, rgb(239, 68, 68) 0%, rgb(239, 68, 68) ${(duration / 10) * 100}%, rgb(254, 226, 226) ${(duration / 10) * 100}%, rgb(254, 226, 226) 100%)`
                  }}
                />
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-gradient-to-r from-red-500 to-orange-500 text-white font-black text-base hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isGenerating ? (
                  <>
        ...
        <div className="flex-1 bg-gray-50 overflow-hidden flex items-center justify-center relative">
          {generatedVideos.length === 0 ? (
            ...
            <div className="text-center max-w-2xl px-8">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-red-500/30">
                <Video className="w-12 h-12 text-white" strokeWidth={2} />
              </div>
              <h2 className="text-3xl font-black bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent mb-3">
                Google Veo 2.0
              </h2>
              <p className="text-content-faint font-medium text-lg mb-8">
                Create cinematic AI videos with realistic motion, physics, and camera work
              </p>
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 bg-white border-2 border-red-200 rounded-2xl">
                  <p className="text-xs font-bold text-red-600 mb-1">STEP 1</p>
                ...
                <div className="p-4 bg-white border-2 border-red-200 rounded-2xl">
                  <p className="text-xs font-bold text-red-600 mb-1">STEP 2</p>
                ...
                <div className="p-4 bg-white border-2 border-red-200 rounded-2xl">
                  <p className="text-xs font-bold text-red-600 mb-1">STEP 3</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {generatedVideos.map((video, index) => (
                        <div
                          key={index}
                          className="group relative aspect-video rounded-xl overflow-hidden bg-gray-100 cursor-pointer hover:ring-2 hover:ring-red-500 transition-all"
                        >
                          <img
                            src={video}
